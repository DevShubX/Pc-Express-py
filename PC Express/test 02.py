...
mycursor=mydb.cursor()
mycursor.execute("create table Motherboard(Name varchar(100),Company varchar(100),Socket_type varchar(100),Chipset varchar(100),Qty char(100),Price char(100))")
...
mydb=mysql.connector.connect(host="localhost",user="root",passwd="",db="pc_express")
mycursor=mydb.cursor()
mycursor.execute("create table Processor(Company varchar(100),Name varchar(100),Cores varchar(100),Socket_type varchar(100),Base_clock varchar(100),Boost_clock varchar(100),Qty char(100),Price varchar(100))")
...
mydb=mysql.connector.connect(host="localhost",user="root",passwd="",db="pc_express")
mycursor=mydb.cursor()
mycursor.execute("create table Rams(Company varchar(100),Name varchar(100),Size varchar(100),Speed varchar(100),Ram_type varchar(100),Qty varchar(100),Price varchar(100))")
...
mydb=mysql.connector.connect(host="localhost",user="root",passwd="",db="pc_express")
mycursor=mydb.cursor()
mycursor.execute("create table Storage(Company varchar(100),Name varchar(100),Type varchar(100),Speed varchar(100),Size varchar(100),Qty varchar(100),Price varchar(100))")
